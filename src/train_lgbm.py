...
ytrain = pd.read_csv("output/ytrain_fl_0.csv")
xval = pd.read_csv("output/xval_fl_0.csv")
yval = pd.read_csv("output/yval_fl_0.csv")
...
df_imp.to_csv("output/importance.csv", index=False)
...
# write predictions
xval[["Env", "Hybrid", "ytrue", "ypred"]].to_csv("output/pred.csv", index=False)
